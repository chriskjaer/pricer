...
},{"./products":2,"angular":8,"angular-route":7}],2:[function(require,module,exports){
'use strict';
...
},{"./products.controller":3,"./products.routes":4,"./products.service":5}],3:[function(require,module,exports){
'use strict';
...
},{"./products.template.jade":6}],5:[function(require,module,exports){
'use strict';
...
buf.push("<div ng-controller=\"ProductsController as app\" class=\"flex-grid\"><div ng-repeat=\"product in app.products\" class=\"tile\"><img ng-src=\"{{product.img}}\"/><h2 class=\"delta tight\">{{product.name}}</h2><p class=\"small\">{{product.brand}}</p><p class=\"price\">{{'kr. ' + product.price}}</p></div></div>");;return buf.join("");
};
