...
},{"./filter.controller":1,"./filter.routes":3,"./filter.service":4,"./products":6,"angular-ui-router":12}],6:[function(require,module,exports){
'use strict';
...
},{"./products.controller":7,"./products.routes":9,"./products.service":10,"angular-ui-router":12}],7:[function(require,module,exports){
'use strict';
...
buf.push("<input type=\"range\"/><div data-flex=\"data-flex\"><div data-flex-item=\"data-flex-item\" ng-repeat=\"product in products.data | filter: $stateParams | limitTo: 10\"><div class=\"tile\"><div class=\"tile__image\"><img ng-src=\"{{product.img}}\"/></div><h2 class=\"delta flush\">{{product.name}}</h2><p class=\"flush small\">{{product.brand}}</p><p class=\"flush price\">{{product.price | currency: 'kr. '}}</p></div></div></div>");;return buf.join("");
};
...
},{"./filter":5,"angular":13}],12:[function(require,module,exports){
/**
