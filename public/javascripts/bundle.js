...
},{"./products":2,"angular":9,"angular-route":8}],2:[function(require,module,exports){
'use strict';
...
},{"./products.routes":6,"./products.service":7,"ui-router/release/angular-ui-router":11}],3:[function(require,module,exports){
'use strict';
...
buf.push("<div data-flex=\"data-flex\"><div data-flex-item=\"data-flex-item\" ng-repeat=\"product in products | filter: filterSettings | limitTo: 10\"><div class=\"tile\"><div class=\"tile__image\"><img ng-src=\"{{product.img}}\"/></div><h2 class=\"delta flush\">{{product.name}}</h2><p class=\"flush small\">{{product.brand}}</p><p class=\"flush price\">{{product.price | currency: 'kr. '}}</p></div></div></div>");;return buf.join("");
};
